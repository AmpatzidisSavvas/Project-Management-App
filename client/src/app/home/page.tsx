...
const HomePage = () => {
  ...
  // State to manage selected projectId
  const [selectedProjectId, setSelectedProjectId] = useState<number | null>(
    null,
  );
  
  // Fetch tasks based on selected projectId (number)
  const {
    data: tasks,
    isLoading: tasksLoading,
    isError: tasksError,
  } = useGetTasksQuery({ projectId: selectedProjectId ?? 0 });
  ...
  return (
    <div className="container h-full w-[100%] bg-gray-100 bg-transparent p-8">
      ...
      <div className="mb-4">
        ...
        <select
          id="project-select"
          className="rounded-md border p-2 dark:bg-dark-secondary dark:text-white"
