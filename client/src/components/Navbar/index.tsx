    ...
    <div className="flex items-center justify-between bg-white px-4 py-3 dark:bg-black">
      ...
      <div className="flex items-center gap-8">
        ...
        <div className=" relative flex h-min w-[200px]">
          ...
          <input
            className="w-full rounded border-none bg-gray-100 p-2 pl-8 placeholder-gray-500 focus:border-transparent focus:outline-none dark:bg-gray-700 dark:text-gray-200 dark:placeholder-gray-200"
            type="search"
            placeholder="Search..."
          />
        </div>
      ...
      <div className="flex items-center">
        ...
        <div className='md:inline-block" ml-2 mr-5 hidden min-h-[2em] w-[0.1rem] bg-gray-200'></div>
      </div>
    </div>
  );
}
